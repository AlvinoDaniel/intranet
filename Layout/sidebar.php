        ...
        <div class="h-full bg-white dark:bg-[#0e1726]">
            <div class="flex items-center justify-between px-4 py-3">
                <a href="index.html" class="main-logo flex shrink-0 items-center">
                    ...
                    <span class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">UDO</span>
                </a>
                <a
                    href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto low-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: 'dashboard' }">
                <li class="menu nav-item">
                        <a href="./index.php" class="group <?php if($item == 'main') echo 'active' ?>">
                    ...
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="./index.php?item=carga-familiar" class="group <?php if($item == 'carga-familiar') echo 'active' ?>">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Carga Familiar</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="./index.php?item=fp020" class="group <?php if($item == 'fp020') echo 'active' ?>">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">FP-020</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="./index.php?item=impuesto" class="group <?php if($item == 'impuesto') echo 'active' ?>">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Impuestos (AR-C)</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/intranet/personal/mantenimientos/certificacion_cuenta_nomina.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank" class="group">
                                <div class="flex items-center">
                                    <svg
                                        class="group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark"
                                        >Certificación Cuenta Nómina</span
                                    >
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <button
                                ...
                                :class=" {'active' : activeDropdown==='carnet' }"
                                @click="activeDropdown === 'carnet' ? activeDropdown = null : activeDropdown = 'carnet'"
                                >
                                <div class="flex items-center">
                                    <svg
                                        class="group-hover:!text-primary"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Carnet</span>
                                </div>
                            </button>
                                <ul x-cloak x-show="activeDropdown === 'carnet'" x-collapse class="sub-menu text-gray-500">
                                    <li>
                                        <a href="/intranet/Carnet Carga Familiar/r_carnetfam_intranet.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">CARNET CARGA FAMILIAR</a>
                                    </li>
                                    <li>
                                        <a href="/intranet/Carnet Funcionarios/carnet_funcionarios.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">CARNET FUNCIONARIO</a>
                                    </li>
                                </ul>
                        </li>
                        <li class="menu nav-item">
                            <button
                                type="button"
                                class="nav-link group"
                                :class=" {'active' : activeDropdown==='constancias' }"
                                @click="activeDropdown === 'constancias' ? activeDropdown = null : activeDropdown = 'constancias'"
                                >
                                <div class="flex items-center">
                                    <svg
                                        class="group-hover:!text-primary"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Constancias</span>
                                </div>
                            </button>
                                <ul x-cloak x-show="activeDropdown === 'constancias'" x-collapse class="sub-menu text-gray-500">
                                    <li>
                                        <a href="/intranet/personal/mantenimientos/Constancia_sueldo_integral.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">SUELDO INTEGRAL PERSONAL ACTIVO</a>
                                    </li>
                                    <li>
                                        <a href="/intranet/personal/mantenimientos/Constancia_sueldo_integral_bono_alimentacion_vacacional.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">SUELDO INTEGRAL + BONOS PERSONAL ACTIVO</a>
                                    </li>
                                    <li>
                                        <a href="/intranet/personal/mantenimientos/Constancia_sueldo_base.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">SUELDO BASE PERSONAL ACTIVO</a>
                                    </li>
                                    <li>
                                        <a href="/intranet/personal/mantenimientos/Constancia_sin_sueldo.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">SIN SUELDO PERSONAL ACTIVO</a>
                                    </li>
                                    <li>
                                        <a href="/intranet/personal/mantenimientos/Constancia_jubilados_sin_sueldo.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">SIN SUELDO PERSONAL JUBILADO</a>
                                    </li>
                                    <li>
                                        <a href="/intranet/personal/mantenimientos/Constancia_jubilados.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">SUELDO INTEGRAL PERSONAL JUBILADO</a>
                                    </li>
                                    <li>
                                        <a href="/intranet/personal/mantenimientos/Constancia_jubilados_bonos.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">SUELDO INTEGRAL + BONOS PERSONAL JUBILADO</a>
                                    </li>
                                    <li>
                                        <a href="/intranet/personal/mantenimientos/Constancia_pension_incapacidad_bonos.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">SUELDO INTEGRAL + BONOS PERSONAL PENSION POR INCAPACIDAD</a>
                                    </li>
                                    <li>
                                        <a href="/intranet/personal/mantenimientos/Constancia_pension_sobrev_bonos.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">SUELDO INTEGRAL + BONOS PERSONAL PENSION POR SOBREVIVIENTE</a>
                                    </li>
                                    <li>
                                        <a href="/intranet/personal/mantenimientos/Constancia_con_carga_familiar.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">CON CARGA FAMILIAR</a>
                                    </li>
                                </ul>
                        </li>
                    </ul>
                ...
                <li class="menu nav-item">
                    <!-- <a href=".php" class="nav-link group"> -->
                        <a href="./index.php?item=nominasCompletas" class="group <?php if($item == 'nominasCompletas') echo 'active' ?>" >
                        <div class="flex items-center">
                            <svg
                                class="group-hover:!text-primary"
                                width="20"
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Edo. de cta. Nóminas Completas</span>
                        </div>
                    </a>
                </li>
                <li class="menu nav-item">
                    <a href="./index.php?item=nominasRegulares" class="group <?php if($item == 'nominasRegulares') echo 'active' ?>" >
                        <div class="flex items-center">
                            <svg
                                class="group-hover:!text-primary"
                                width="20"
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Edo. de cta. Nóminas Regulares</span>
                        </div>
                    </a>
                </li>
                <li class="menu nav-item">
                    <a href="./index.php?item=otrasNominas" class="group <?php if($item == 'otrasNominas') echo 'active' ?>" >
                        <div class="flex items-center">
                            <svg
                                class="group-hover:!text-primary"
                                width="20"
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Edo. de cta. Otras Nóminas</span>
                        </div>
                    </a>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    >
                        <div class="flex items-center">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Planilla de Solicitud Anticipo de Prestaciones</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'datatables'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/intranet/pasivos/Planilla-Interna-Docentes.doc" target="_blank">INTERNO DOCENTES</a>
                        </li>
                        <li>
                            <a href="/intranet/pasivos/Planilla-Interna-Administrativos.doc" target="_blank">INTERNO ADMINISTRATIVOS</a>
                        </li>
                        <li>
                            <a href="/intranet/pasivos/Planilla-Interna-Obreros.doc" target="_blank">INTERNO OBREROS</a>
                        </li>
                        <li>
                            <a href="/intranet/pasivos/Planilla-Solicitud-Anticipo-Opsu.pdf" target="_blank">OPSU</a>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item">
                    <a href="/intranet/pasivos/papeleta_obreros.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">
                        <button
                            type="button"
                            class="nav-link group"
                        ...
                        >
                            <div class="flex items-center">
                                ...
                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Estado de cuenta - FIDEICOMISO / 8.5% 2023</span>
                            </div>
                ...
                <li class="menu nav-item">
                    <a href="/intranet/pasivos/calc_presta.php?formidinf=usht1f9pefbhd271n2r35p8sv7&id=1GGUwSJLLGy/2&datossl=MXx8fDF8fHwxfHx8MXx8fDB8fHww" target="_blank">
                        <button
                            type="button"
                            class="nav-link group"
                        ...
                        >
                            <div class="flex items-center">
                                ...
                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Estado de cuenta - Prestaciones Estimadas</span>
                            </div>
