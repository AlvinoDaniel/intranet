        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            ...
            <div class="flex min-h-screen items-center justify-center bg-[url('../images/map.svg')] bg-cover bg-center dark:bg-[url('../images/map-dark.svg')]">
                <div class="panel m-6 w-full max-w-lg sm:w-[480px]">
                    <h2 class="mb-3 text-2xl font-bold">Bienvenido</h2>
                    <p class="mb-7">Ingrese los datos solicitados para entrar al sistema</p>
                    <form class="space-y-5" name="form1" method="post" action="identificacion.php">
                        <div>
                            <label for="email">Cedula</label>
                            <input id="usuario" name="usuario" type="text" class="form-input" placeholder="Ingrese cedula" />
                        </div>
                        <div>
                            <label for="password">Contraseña</label>
                            <input id="clave" name="clave" type="password" class="form-input" placeholder="Ingrese su clave" />
                        </div>
                        <!-- <div>
                    ...
                    <div
                        class="relative my-7 h-5 text-center"
                    >
                    <p class="text-center mt-3">
                        ¿Olvidaste tu Contraseña? <a href="recuperar-clave.php" class="font-bold text-primary hover:underline">Click aquí</a>
                    </p>
                </div>
            </div>
